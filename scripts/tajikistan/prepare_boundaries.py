...
INFILE = Path("data/raw/tajikistan/boundaries/tj.json")
OUTFILE = Path("data/interim/tajikistan/tajikistan_regions.geojson")
...
def main():
    ...
    NAME_FIXES = {
        "Dushanbe": "Dushanbe",
        "Leninabad": "Sughd",
        "Tadzhikistan Territories": "Districts under Republic Subordination",
