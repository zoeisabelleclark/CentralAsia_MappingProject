...
INFILE = Path("data/interim/kazakhstan/urban_rural_combined.csv")
CROSSWALK_FILE = Path("data/raw/kazakhstan/reference/kazakhstan_region_crosswalk.csv")
OUTFILE = Path("data/interim/kazakhstan/urban_rural_clean.csv")
...
def main():
    ...
    if unmatched:
        ...
        for name in unmatched:
            print("-", name)
        raise ValueError("Some Kazakhstan region names are missing from the crosswalk.")
