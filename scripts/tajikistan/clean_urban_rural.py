...
INFILE = Path("data/interim/tajikistan/urban_rural_long.csv")
CROSSWALK_FILE = Path("data/raw/tajikistan/reference/region_crosswalk.csv")
OUTFILE = Path("data/interim/tajikistan/urban_rural_clean.csv")
...
def main():
    ...
    if unmatched:
        ...
        for name in unmatched:
            print("-", name)
        raise ValueError("Some Tajikistan region names are missing from the crosswalk.")
